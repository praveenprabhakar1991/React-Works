               ...
               <div className="col-md-5">
                  <div className="card">
                     ...
                     <div className="card-body">
                        ...
                        <hr />
                        <h5> Quantity : &nbsp;
                           <i class="fa-solid fa-minus" onClick={this.messageHandler.bind(this, this.state.Quantity - 1)}> </i> &nbsp;
                           {this.state.Quantity} &nbsp;
                           <i class="fa-solid fa-plus" onClick={this.messageHandler.bind(this, this.state.Quantity + 1)}></i> </h5>
                        <hr />
