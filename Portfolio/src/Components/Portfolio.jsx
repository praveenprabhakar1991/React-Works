...
class Portfolio extends Component {
   ...
   Projects = [
      ...
      },
      {
         Name: "News App",
         Image: Newsapp,
         Tags: ["HTML", "Bootstrap", "JavaScript", "JQuery", "React"],
         Live: " ",
                     ...
                     this.Projects.map((Project) => {
                        return <div className="col-md-4 text-center mt-5" key={Project.Name}>
                           <div className="card shadow-sm">
                              ...
                              <h5><span className="badge bg-light rounded-pill text-primary shadow-sm">{Project.Tags[0]}</span> <span className="badge bg-light rounded-pill text-primary shadow-sm">{Project.Tags[1]}</span> <span className="badge bg-light rounded-pill text-primary shadow-sm">{Project.Tags[2]}</span></h5>
                              <h5><span className="badge bg-light rounded-pill text-primary shadow-sm">{Project.Tags[3]}</span> <span className="badge bg-light rounded-pill text-primary shadow-sm">{Project.Tags[4]}</span></h5>
                              <div className="card-body">
